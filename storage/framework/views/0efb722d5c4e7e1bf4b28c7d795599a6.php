                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.dashboard')); ?>" data-section="dashboard">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('admin.indoors') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.indoors')); ?>" data-section="grounds">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('admin.bookings') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.bookings')); ?>" data-section="bookings">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('admin.customers') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.customers')); ?>" data-section="customers">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('admin.indoor-admins') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.indoor-admins')); ?>" data-section="indoor-admins">
...
</html><?php /**PATH C:\Users\MY\Desktop\indoor\resources\views/components/layouts/admin.blade.php ENDPATH**/ ?>