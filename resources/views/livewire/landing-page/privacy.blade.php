<div>
    ...
    <section class="container privacy-section">
        ...
        <ul>
            <li>Personal details (name, email address, phone number, etc.) provided during registration or booking.</li>
            <li>Payment details for processing secure transactions.</li>
        ...
        <ul>
            ...
            <li>Send important updates, offers, or notifications (with your consent).</li>
        </ul>
